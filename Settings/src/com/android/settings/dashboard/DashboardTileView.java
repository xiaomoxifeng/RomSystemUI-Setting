...
public class DashboardTileView extends FrameLayout implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        {
            Intent intent = new Intent("android.intent.action.VIEW", Uri.parse("http://downloadcenter.samsung.com/content/MC/201504/20150403192510053/C3/Sch/start_here.html"));
