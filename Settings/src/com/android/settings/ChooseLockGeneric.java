...
public class ChooseLockGeneric extends SettingsActivity {
    ...
    public static class ChooseLockGenericFragment extends SettingsPreferenceFragment {
        ...
        public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen,
            ...
            Log.d("FLOW_ROM_TAG", "preferenceScreen"+preferenceScreen+"preference"+preference+"key"+key);
            if (!isUnlockMethodSecure(key) && mLockPatternUtils.isSecure()) {
            	 Log.d("FLOW_ROM_TAG", "!isUnlockMethodSecure(key) && mLockPatternUtils.isSecure()");
                // Show the disabling FRP warning only when the user is switching from a secure
                // unlock method to an insecure one
                showFactoryResetProtectionWarningDialog(key);
                return true;
            } else {
           	 Log.d("FLOW_ROM_TAG", "setUnlockMethod(key)");
        ...
        protected void disableUnusablePreferencesImpl(final int quality,
        	...
        	Log.d("FLOW_ROM_TAG", "quality"+quality +"allowBiometric"+allowBiometric+"hideDisabled"+hideDisabled);
        ...
        void updateUnlockMethodAndFinish(int quality, boolean disabled) {
            ...
            if (quality >= DevicePolicyManager.PASSWORD_QUALITY_NUMERIC) {
            	...
            	Log.d("FLOW_ROM_TAG", "DevicePolicyManager.PASSWORD_QUALITY_UNSPECIFIED)"+DevicePolicyManager.PASSWORD_QUALITY_UNSPECIFIED+"disabled"+disabled);
        ...
        private boolean setUnlockMethod(String unlockMethod) {
            Log.d("FLOW_ROM_TAG", "setUnlockMethod(String unlockMethod)"+unlockMethod);
