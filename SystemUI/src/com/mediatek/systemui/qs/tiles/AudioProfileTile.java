...
public class AudioProfileTile extends QSTile<QSTile.BooleanState> {
    ...
    private int mAudioState = R.drawable.tw_quick_panel_icon_silent_off;
    ...
    private void loadEnabledProfileResource(Scenario scenario) {
        ...
        case GENERAL:
            ...
            mAudioState = R.drawable.tw_quick_panel_icon_silent_off;
            break;
        case MEETING:
            mMettingProfileIcon.setImageResource(R.drawable.ic_qs_meeting_profile_enable);
            mAudioState = R.drawable.tw_quick_panel_icon_silent_mode_on_on;
            break;
        case OUTDOOR:
        ...
        case SILENT:
            ...
            mAudioState = R.drawable.tw_quick_panel_icon_silent_on;
            break;
        case CUSTOM:
            mAudioState = R.drawable.tw_quick_panel_icon_silent_off;
        default:
