...
public class RecentsActivity extends Activity implements RecentsView.RecentsViewCallbacks,
    ...
    /// @}
   View mRecentButton;
   FinishRecentsRunnable mFinishByCloseAllButton;
   Button mCloseAllButtons; //grape_keyguard 
    /**
            ...
            ActivityOptions.makeCustomAnimation(this,
                mConfig.launchedFromSearchHome ? R.anim.recents_to_search_launcher_enter :
                    ...
                    mConfig.launchedFromSearchHome ? R.anim.recents_to_search_launcher_exit :
                        R.anim.recents_to_launcher_exit));
//grape_keyguard
       mFinishByCloseAllButton = new FinishRecentsRunnable(homeIntent, ActivityOptions.makeCustomAnimation(this, R.anim.recents_to_launcher_enter_by_close_all_button, R.anim.recents_to_launcher_exit_by_close_all_button));
//end
...
//grape_keyguard
			...
			{
			    mConfig.closeAllButtonVisibility = false;
...
//grape_keyguard
		if(mRecentButton != null)
		{
		    mConfig.closeAllButtonVisibility = true;
		    mRecentButton.setVisibility(0);
		    android.view.animation.Animation animation = AnimationUtils.loadAnimation(this, R.anim.recents_show_close_all_button);
		    mRecentButton.startAnimation(animation);
		}
//end            
...
//grape_keyguard
	if(mConfig.closeAllButtonVisibility)
	{
	    mConfig.closeAllButtonVisibility = false;
	    android.view.animation.Animation animation = AnimationUtils.loadAnimation(this, R.anim.recents_hide_close_all_button);
	    mRecentButton.setVisibility(8);
	    mRecentButton.startAnimation(animation);
	}
//end
...
//grape_keyguard
        mRecentButton = ((LinearLayout)findViewById(R.id.clear_all_button_view));
        mRecentButton.setVisibility(8);

		mCloseAllButtons = (Button)findViewById(R.id.clear_all_button);
		mCloseAllButtons.setOnClickListener(new View.OnClickListener() {
		    ...
		    public void onClick(View v) {
		        ...
		        if(mConfig.closeAllButtonVisibility) {
		            mConfig.closeAllButtonVisibility = false;
		            Animation localAnimation = AnimationUtils.loadAnimation(RecentsActivity.this, R.anim.recents_hide_close_all_button);
		            mRecentButton.setVisibility(0x8);
		            mRecentButton.startAnimation(localAnimation);
		        }
		        mFinishByCloseAllButton.run();
		    }
		});
//end
