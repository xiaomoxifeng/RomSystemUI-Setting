...
public abstract class BaseStatusBar extends SystemUI implements
    ...
    protected View.OnTouchListener mRecentsPreloadOnTouchListener = new View.OnTouchListener() {
        ...
        public boolean onTouch(View v, MotionEvent event) {
            ...
            Log.d(Constants.FLOW_TAG,"onTouch ");
    ...
    protected class H extends Handler {
        public void handleMessage(Message m) {
        	Log.d(Constants.FLOW_TAG,"handleMessage"+m.what);
            switch (m.what) {
             ...
             case MSG_PRELOAD_RECENT_APPS:
           	  ...
           	  if (Constants.isShowLeft) {
                 	intent.setAction(Constants.onHide);
                 	Constants.isShowLeft=false;
                 	Log.d(Constants.FLOW_TAG, "MSG_TOGGLE_RECENTS_APPS onHide");
                 } else {
               	intent.setAction(Constants.onShow);
               	Constants.isShowLeft=true;
                 	Log.d(Constants.FLOW_TAG, "MSG_TOGGLE_RECENTS_APPS onShow");
                 }
