...
public class NotificationPanelView extends PanelView implements
    ...
    private StatusBarKeyguardViewManager mStatusBarKeyguardViewManager; //grape_S6 keyguard
    ...
    protected void loadDimens() {
        ...
        mQsPeekHeight = 0;//getResources().getDimensionPixelSize(R.dimen.qs_peek_height); grape_S6
    ...
    public void setQsExpansionEnabled(boolean qsExpansionEnabled) {
        Log.d(TAG, "setQsExpansionEnabled: qsExpansionEnabled="+qsExpansionEnabled + ", caller: " + Debug.getCallers(12));
...
//grape_S6 keyguard
    ...
    {
      KeyguardEffectViewMain localKeyguardEffectViewMain = getUnlockEffectview();
      if ((localKeyguardEffectViewMain != null) && (!mStatusBarKeyguardViewManager.isSecure()))
        localKeyguardEffectViewMain.onLockScreenWallpaperSet();
    }

    public KeyguardEffectViewMain getUnlockEffectview()
    {
      return mKeyguardBottomArea.getUnlockEffectView();
    }
//end
    ...
    public void onOverscrollTopChanged(float amount, boolean isRubberbanded) {
        cancelAnimation();
        Log.d(TAG , "onOverscrollTopChanged:="+mQsExpansionEnabled+", amount="+amount+", isRubberbanded="+isRubberbanded + ", caller: " + Debug.getCallers(12));
        if (!mQsExpansionEnabled) {
            amount = 0f;
        }
    ...
    public void flingTopOverscroll(float velocity, boolean open) {
        Log.d(TAG , "flingTopOverscroll: mQsExpansionHeight="+mQsExpansionHeight + ", caller: " + Debug.getCallers(12));
...
//grape_S6
    private void setQsExpansionEx(float height) {
        setQsExpansion(mKeyguardShowing? height : mQsMaxExpansionHeight);
    }

//end

    private void setQsExpansion(float height) {
        Log.d(TAG, "setQsExpansion: height="+height);    
        //if (height == mQsMinExpansionHeight && mHeader.getExpandedHeight() == height && mKeyguardShowing == false)
          //  height = 124;
        height = Math.min(Math.max(height, mQsMinExpansionHeight), mQsMaxExpansionHeight);
        Log.d(TAG, "setQsExpansion: height="+height+", mQsMinExpansionHeight="+mQsMinExpansionHeight+", mQsMaxExpansionHeight="+mQsMaxExpansionHeight + ", caller: " + Debug.getCallers(12));
    ...
    protected void onExpandingStarted() {
        ...
        Log.d(TAG, "onExpandingStarted:mQsExpanded="+mQsExpanded + ",mQsFullyExpanded="+mQsFullyExpanded);
        ...
        {
            /*if (false == mQsFullyExpanded) {
        	  flingSettings(0,true); //grape_S6
        	  mQsExpandImmediate = true;
            }*/
        }
    }
    ...
    protected void onExpandingFinished() {
        Log.d(TAG, "onExpandingFinished:mQsExpanded="+mQsExpanded);
...
//grape_S6 keyguard
    ...
    {
      KeyguardEffectViewMain localKeyguardEffectViewMain = getUnlockEffectview();
      mStatusBarKeyguardViewManager = paramStatusBarKeyguardViewManager;
      if (localKeyguardEffectViewMain != null)
        localKeyguardEffectViewMain.setKeyguardViewManager(paramStatusBarKeyguardViewManager);
    }
    ...
    public void setKeyguardMediatorCallback(ViewMediatorCallback paramViewMediatorCallback)
    {
      KeyguardEffectViewMain localKeyguardEffectViewMain = getUnlockEffectview();
      if (localKeyguardEffectViewMain != null)
        localKeyguardEffectViewMain.setKeyguardMediatorCallback(paramViewMediatorCallback);
    }
    ...
    public void onScreenTurnedOff()
    {
      KeyguardEffectViewMain localKeyguardEffectViewMain = getUnlockEffectview();
      if (localKeyguardEffectViewMain != null)
        localKeyguardEffectViewMain.screenTurnedOff();
    }
//end
...
//grape_S6 keyguard
		KeyguardEffectViewMain localKeyguardEffectViewMain = getUnlockEffectview();
		if ((localKeyguardEffectViewMain != null) && (!mStatusBarKeyguardViewManager.isSecure()))
		  localKeyguardEffectViewMain.screenTurnedOn();
//end
    }
