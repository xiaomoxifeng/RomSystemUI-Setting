...
//grape_S6 keyguard    
    private int mKeyguardStatusMariginTop;
...
//grape_S6 keyguard
        ...
        mKeyguardStatusMariginTop = res.getDimensionPixelSize(R.dimen.tw_keyguard_status_margin_top);
//end
    }
    ...
    public void run_org(Result result) {
...
//grape_S6 keyguard
    ...
    {
        int i = mStatusbarHeight + mKeyguardStatusMariginTop;
        result.stackScrollerPaddingAdjustment = (int)(getClockYExpansionAdjustment() * getTopPaddingAdjMultiplier());
        int j = i + (getClockNotificationsPadding() + result.stackScrollerPaddingAdjustment);
        result.clockY = i;
        result.stackScrollerPadding = j + mKeyguardStatusHeight;
        result.clockScale = getClockScale(result.stackScrollerPadding, result.clockY, i + getClockNotificationsPadding() + mKeyguardStatusHeight);
        result.clockAlpha = getClockAlpha(result.clockScale);
    }
//end
