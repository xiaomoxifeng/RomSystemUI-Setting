...
public class KeyguardAffordanceView extends ImageView {
    ...
    public KeyguardAffordanceView(Context context, AttributeSet attrs, int defStyleAttr,
        ...
        mArrowDrawable = context.getDrawable(R.drawable.tw_keyguard_shortcut_arrow);//grape_S6 keyguard
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //drawArrow(canvas);
        //TwdrawArrow(canvas);//grape_S6 keyguard
        canvas.save();
...
//grape_S6 keyguard
    private void TwdrawArrow(Canvas canvas)
    {
        if(mArrowAlpha > 0.0F)
        {
            canvas.save();
            mArrowDrawable.setAlpha(255 * (int)mArrowAlpha);
