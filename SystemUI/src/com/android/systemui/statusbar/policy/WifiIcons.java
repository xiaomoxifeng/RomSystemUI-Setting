...
*/
    ...
    static final int[][] WIFI_SIGNAL_STRENGTH_INOUT = { //grape_S6
        { R.drawable.tw_stat_sys_wifi_signal_0_fully,
          R.drawable.tw_stat_sys_wifi_signal_0_fully,
          R.drawable.tw_stat_sys_wifi_signal_0_fully,
          R.drawable.tw_stat_sys_wifi_signal_0_fully },

        { R.drawable.tw_stat_sys_wifi_signal_1_fully,
          R.drawable.tw_stat_sys_wifi_signal_1_fully_in,
          R.drawable.tw_stat_sys_wifi_signal_1_fully_out,
          R.drawable.tw_stat_sys_wifi_signal_1_fully_inout },

        { R.drawable.tw_stat_sys_wifi_signal_2_fully,
          R.drawable.tw_stat_sys_wifi_signal_2_fully_in,
          R.drawable.tw_stat_sys_wifi_signal_2_fully_out,
          R.drawable.tw_stat_sys_wifi_signal_2_fully_inout },

        { R.drawable.tw_stat_sys_wifi_signal_3_fully,
          R.drawable.tw_stat_sys_wifi_signal_3_fully_in,
          R.drawable.tw_stat_sys_wifi_signal_3_fully_out,
          R.drawable.tw_stat_sys_wifi_signal_3_fully_inout },

        { R.drawable.tw_stat_sys_wifi_signal_4_fully,
          R.drawable.tw_stat_sys_wifi_signal_4_fully_in,
          R.drawable.tw_stat_sys_wifi_signal_4_fully_out,
          R.drawable.tw_stat_sys_wifi_signal_4_fully_inout }
    };
    /// M: Wifi activity icon @}
    ...
    static final int[] WIFI_SIGNAL_STRENGTH_FULL = {//grape_S6
          R.drawable.tw_stat_sys_wifi_signal_0_fully,
          R.drawable.tw_stat_sys_wifi_signal_1_fully,
          R.drawable.tw_stat_sys_wifi_signal_2_fully,
          R.drawable.tw_stat_sys_wifi_signal_3_fully,
