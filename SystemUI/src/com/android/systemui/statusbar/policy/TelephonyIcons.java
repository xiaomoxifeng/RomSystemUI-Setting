...
public class TelephonyIcons {
    ...
    static final int[] TELEPHONY_SIGNAL_STRENGTH_FULL = {  //grape_S6
          R.drawable.tw_stat_sys_signal_dark_1,
          R.drawable.tw_stat_sys_signal_dark_2,
          R.drawable.tw_stat_sys_signal_dark_3,
          R.drawable.tw_stat_sys_signal_dark_4,
          R.drawable.tw_stat_sys_signal_dark_4,
    };
...
//grape_S6
    static public int getNetworkTypeIconMac(NetworkType networkType) {
        if (networkType == NetworkType.Type_G) {
            return R.drawable.tw_stat_sys_data_connected_g;
        } else if (networkType == NetworkType.Type_E) {
            return R.drawable.tw_stat_sys_data_connected_e;   
        } else if (networkType == NetworkType.Type_3G) {
            return R.drawable.tw_stat_sys_data_connected_h;
        } else if (networkType == NetworkType.Type_4G) {
            if (SystemProperties.get("persist.sys.4G_switch").equals("LTE"))
            return R.drawable.tw_stat_sys_data_connected_lte;
            else
                return R.drawable.tw_stat_sys_data_connected_4g;
        } else if (networkType == NetworkType.Type_1X) {
            return R.drawable.stat_sys_network_type_1x;
        } else if (networkType == NetworkType.Type_1X3G) {
            return R.drawable.stat_sys_network_type_3g;
    ...
    static public int getNetworkDataInoutMac(boolean in, boolean out) {
        if (in && out)
        {
        	return R.drawable.tw_stat_sys_signal_inout;
        }
        else if (false == in && false == out)
        {
            return -1;
        }
        else if (in)
        {
        	return R.drawable.tw_stat_sys_signal_in;
        }
        else if (out)
        {
        	return R.drawable.tw_stat_sys_signal_out;
        }        
        else {
            return -1;
        }
