...
//grape_S6
        if (mAutomatic != automatic)
        {
            ...
            Settings.System.putInt(mContext.getContentResolver(),
                                    Settings.System.SCREEN_BRIGHTNESS_MODE, mAutomatic ? 1 : 0);
        }
//end
        if (!mAutomatic) {
    ...
    private void updateIcon(boolean automatic) {
        if (mIcon != null) {
            mIcon.setImageResource(automatic /*&& SHOW_AUTOMATIC_ICON*/ ?
                    com.android.systemui.R.drawable.tw_ic_qs_brightness_auto_on :
                    com.android.systemui.R.drawable.tw_ic_qs_brightness_auto_off);
        }
    }
    ...
    private void updateMode() {
        if (mAutomaticAvailable) {
            ...
            mControl.setChecked(mAutomatic); //grape_S6
        } else {
