...
//end
    ...
    public ToggleSlider(Context context, AttributeSet attrs, int defStyle) {
        ...
        View.inflate(context, R.layout.tw_status_bar_toggle_slider, this); //grape_S6
...
//grape_S6
    ...
    {
    	mLabel.setText(mContext.getResources().getString(R.string.status_bar_settings_auto_brightness_label));
    }
//end
