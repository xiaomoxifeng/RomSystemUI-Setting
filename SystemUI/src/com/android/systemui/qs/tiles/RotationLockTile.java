...
public class RotationLockTile extends QSTile<QSTile.BooleanState> {
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        ...
        if (rotationLocked) {
            ...
            state.label = mContext.getString(R.string.quick_settings_rotation_unlocked_label); //grape_S6
            icon = portrait ? mAutoToPortrait : mAutoToLandscape;
            state.iconId = R.drawable.tw_quick_panel_icon_rotation_off;
        } else {
            state.label = mContext.getString(R.string.quick_settings_rotation_unlocked_label);
            icon = portrait ? mPortraitToAuto : mLandscapeToAuto;
            state.iconId = R.drawable.tw_quick_panel_icon_rotation_on;
        }
