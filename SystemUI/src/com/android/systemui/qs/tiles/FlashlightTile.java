...
public class FlashlightTile extends QSTile<QSTile.BooleanState> implements
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        ...
        state.visible = true; //mWasLastOn != 0 || mFlashlightController.isAvailable();
//        if (DEBUG) Log.d(TAG, "handleUpdateState mWasLastOn != 0=" + (mWasLastOn != 0) + ", mFlashlightController.isAvailable()="+mFlashlightController.isAvailable());
...
//grape_S6
	if(state.value)
	    state.iconId = R.drawable.tw_quick_panel_icon_assistantlight_on;
	else
	    state.iconId = R.drawable.tw_quick_panel_icon_assistantlight_off;
