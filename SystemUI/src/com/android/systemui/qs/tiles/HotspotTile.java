...
public class HotspotTile extends QSTile<QSTile.BooleanState> {
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        state.visible = true; //mController.isHotspotSupported() && mUsageTracker.isRecentlyUsed();
        ...
        if (DEBUG) {
            Log.d(TAG, "handleUpdateState(), airplaneMode= " + airplaneMode + ",mController.isHotspotSupported()="+mController.isHotspotSupported()+",mUsageTracker.isRecentlyUsed()="+mUsageTracker.isRecentlyUsed());
        }
        if (airplaneMode) {
            state.value = false;
        }
        ...
        if(state.visible && state.value)
            state.iconId = R.drawable.tw_quick_panel_icon_wifihotspot_on;
        else
            state.iconId = R.drawable.tw_quick_panel_icon_wifihotspot_off;
