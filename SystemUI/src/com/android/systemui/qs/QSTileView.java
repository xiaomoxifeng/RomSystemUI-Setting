...
public class QSTileView extends ViewGroup {
    ...
    public QSTileView(Context context) {
        ...
        mIconSizePx = res.getDimensionPixelSize(R.dimen.tw_qs_tile_icon_size);
        mTileSpacingPx = res.getDimensionPixelSize(R.dimen.qs_tile_spacing);
        mTilePaddingBelowIconPx = 0;// res.getDimensionPixelSize(R.dimen.qs_tile_padding_below_icon);
    ...
    private void recreateLabel() {
        ...
        if (mDual) {
            ...
            mLabel.setTextColor(res.getColor(R.color.tw_qs_tile_text));
    ...
    protected View createIcon() {
        ...
        icon.setBackgroundResource(R.drawable.tw_quick_panel_quick_setting_button_round_bg);
        return icon;
    }
...
//grape_S6
        //Log.d("grape_QSTileView", "handleStateChanged: state.iconId="+state.iconId+",state.label="+state.label + ",mDual="+mDual); 
           iconId = state.iconId;
           if(state.iconId > 0)
               ((ImageView)mIcon).setImageResource(state.iconId);
           else
//end        
